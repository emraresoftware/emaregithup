...
```python
# Emare GitHup — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emaregithup.view',      # Görüntüleme
    'emaregithup.create',    # Oluşturma
    'emaregithup.edit',      # Düzenleme
    'emaregithup.delete',    # Silme
    'emaregithup.manage',    # Tam yönetim
    # Admin
    'emaregithup.admin',     # Admin panele erişim
    'emaregithup.users',     # Kullanıcı yönetimi
    'emaregithup.settings',  # Ayar yönetimi
]
```
...
```python
# emaregithup/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emaregithup.view', 'emaregithup.create',
        'emaregithup.edit', 'emaregithup.delete',
        'emaregithup.manage', 'emaregithup.users',
        'emaregithup.settings', 'emaregithup.admin',
    },
    'operator': {
        'emaregithup.view', 'emaregithup.create',
        'emaregithup.edit',
...
| Proje Admini | admin@emaregithup.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emaregithup.emare.dev | super_admin | Machine-to-machine |
