# Emare GitHup — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emaregithup
...
| 6 | `emaregithup_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emaregithup Dervishi` bu projeden sorumlu
